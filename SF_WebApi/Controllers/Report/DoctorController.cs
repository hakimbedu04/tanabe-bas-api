...
namespace SF_WebApi.Controllers.Report
{
    public class DoctorController : BaseController
    {
        ...
        public DoctorController(ILoginBLL loginbll)
        {
            _loginbll = loginbll;
        }
        ...
        public IHttpActionResult GetReport(BaseInput inputs)
        {
            ...
            objResponseModel.Result = GetHost() + "/Report/Doctor.aspx?d=" + model.rep_region.Replace(" ", string.Empty) + "&p=" + model.rep_position.Replace(" ", string.Empty) + "&r=" + model.rep_id.Replace(" ", string.Empty);
