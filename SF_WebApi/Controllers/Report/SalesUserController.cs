...
{
    public class SalesUserController : BaseController
    {
        private readonly ILoginBLL _loginbll;

        public SalesUserController(ILoginBLL loginbll)
        {
            _loginbll = loginbll;
        }
        ...
        public IHttpActionResult GetReport(BaseInput inputs)
        {
            ...
            objResponseModel.Result = GetHost() + "/Report/SalesUser.aspx?p=" + model.rep_position.Replace(" ", string.Empty) + "&r=" + model.rep_id.Replace(" ", string.Empty);
