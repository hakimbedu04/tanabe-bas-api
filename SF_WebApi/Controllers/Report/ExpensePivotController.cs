...
{
    public class ExpensePivotController : BaseController
    {
        private readonly ILoginBLL _loginbll;

        public ExpensePivotController(ILoginBLL loginbll)
        {
            _loginbll = loginbll;
        }
        ...
        public IHttpActionResult GetReport(BaseInput inputs)
        {
            ...
            objResponseModel.Result = GetHost() + "/Report/ExpensePivot.aspx?n=" + model.rep_id.Replace(" ", string.Empty);
