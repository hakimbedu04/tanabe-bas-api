...
{
    public class VisitProductController : BaseController
    {
        private readonly ILoginBLL _loginbll;

        public VisitProductController(ILoginBLL loginbll)
        {
            _loginbll = loginbll;
        }
        ...
        public IHttpActionResult GetReport(BaseInput inputs)
        {
            ...
            objResponseModel.Result = GetHost() + "/Report/VisitProduct.aspx?r=" + model.rep_id.Replace(" ", string.Empty);
