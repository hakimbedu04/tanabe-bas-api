...
namespace SF_WebApi.Controllers.Report
{
    public class CoverageController : BaseController
    {
        ...
        public CoverageController(ILoginBLL loginbll)
        {
            _loginbll = loginbll;
        }
        ...
        public IHttpActionResult GetReport(BaseInput inputs)
        {
            ...
            objResponseModel.Result = GetHost() + "/Report/Coverage.aspx?p=" + model.rep_region.Replace(" ", string.Empty) + "&r=" + model.rep_id.Replace(" ", string.Empty);
