    ...
    public partial class Coverage : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                monthVal.SelectedIndex = Convert.ToInt32(currentDate.Month - 1);
                ASPxSpinEdit1.Value = Convert.ToInt32(currentDate.Year);
        ...
        protected void BtnExportExcel_Click(object sender, EventArgs e)
        {
            ...
            var addressPath = headerPath + "/" + txtNik.Text + "/Coverage"; // ~/Asset/Files/Downloads/Pdf/VisitRealization/12.36
            var resultFileName = "coverage.xlsx";
        ...
        protected void BtnExportDataRow_Click(object sender, EventArgs e)
        {
            ...
            var headerPath = (string)settingsReader.GetValue("ReportPath", typeof(String)); //~/Asset/Files/Downloads/Pdf/
            var addressPath = headerPath + "/" + txtNik.Text + "/Coverage"; // ~/Asset/Files/Downloads/Pdf/VisitRealization/12.36
            var resultFileName = "coverage_rowdata.xlsx";
            var resultFilePath = addressPath + "/" + resultFileName;
            if (!Directory.Exists(HttpContext.Current.Server.MapPath(addressPath)))
            {
                Directory.CreateDirectory(HttpContext.Current.Server.MapPath(addressPath));
        ...
        protected void BtnExportPdf_Click(object sender, EventArgs e)
        {
            ...
            var headerPath = (string)settingsReader.GetValue("ReportPath", typeof(String)); //~/Asset/Files/Downloads/Pdf/
            var addressPath = headerPath + "/" + txtNik.Text + "/Coverage"; // ~/Asset/Files/Downloads/Pdf/VisitRealization/12.36
            var resultFileName = "coverage.pdf";
            var resultFilePath = addressPath + "/" + resultFileName;
            if (!Directory.Exists(HttpContext.Current.Server.MapPath(addressPath)))
            {
                Directory.CreateDirectory(HttpContext.Current.Server.MapPath(addressPath));
